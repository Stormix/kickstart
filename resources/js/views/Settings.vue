  ...
  <div class="flex flex-col w-full h-full">
    <SubHeader>
      ...
      <div class="ml-4 text-gray-500">
        Profile informations, password, 2FA ...etc
      </div>
    </SubHeader>
    <div v-if="user" class="px-20 mt-10 space-y-0">
              ...
              <div class="w-full my-auto">
                ...
                <div v-else-if="showQR" class="flex flex-row">
                  <div class="">
                    ...
                    Now that you enabled two factor authentication, you'll need
                    to go through the following steps to use it.
